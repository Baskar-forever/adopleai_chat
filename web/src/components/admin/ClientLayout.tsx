  ...
  return (
    <div className="h-screen overflow-y-hidden">
      <div className="flex h-full">
        <div className="flex-none text-white bg-black w-[250px] z-20 pt-4 pb-8 h-full border-r border-border miniscroll overflow-auto">
          <AdminSidebar
            collections={[
              {
                name: "Connectors",
                    ...
                    ? [
                        {
                          name: (
                            <div className="flex">
                              <SlackIconSkeleton className="text-white" />
                ...
                ? [
                    {
                      ...
                      items: [
                        ...
                        },
                        {
                          name: (
                            <div className="flex">
                              <DocumentIcon2 className="text-white" />
